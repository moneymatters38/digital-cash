...
import uuid, socketserver, socket, sys, argparse, os, logging, threading
import time
...
class Bank:
    ...
    def __init__(self, id, private_key):
        ...
        self.peer_addresses = { (hostname, PORT)
                                for hostname in os.environ['PEERS'].split(',')}
...
class TCPHandler(socketserver.BaseRequestHandler):
    ...
    def handle(self):
        ...
        logger.info("Received message: {0}".format(message))
